...
<?php /*%%SmartyHeaderCode:151350114662eba0dbd4f262-89674795%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '151350114662eba0dbd4f262-89674795',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62eba0dbd52d03_66556472',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62eba0dbd52d03_66556472')) {function content_62eba0dbd52d03_66556472($_smarty_tpl) {?><ul class="thumbs li250px" id="product-list">
    ...
    {% var current_editor = '<?php echo shopHelper::getCurrentProductEditor();?>
'; %}
...
'.replace('@s', p.id).replace('edit/', '')%}{% if (current_editor === 'new_editor' && !p.edit_rights) { %}prices/{% } %}">
                {% if (p.badge) { %}
...
'.replace('@s', p.id)%}{% if (current_editor === 'new_editor' && !p.edit_rights) { %}prices/{% } %}"><i class="icon10 edit s-instant-edit"></i> редактировать</a>
                <br>
