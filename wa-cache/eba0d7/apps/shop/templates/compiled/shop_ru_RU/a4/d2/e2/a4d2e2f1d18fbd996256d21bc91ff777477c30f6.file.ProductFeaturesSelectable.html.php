<?php /* Smarty version Smarty-3.1.14, created on 2022-08-04 12:35:13
         compiled from "C:\xampp\htdocs\wa\wa-apps\shop\templates\actions\product\ProductFeaturesSelectable.html" */ ?>
<?php /*%%SmartyHeaderCode:161025339962eba0e1ea3244-80323046%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '161025339962eba0e1ea3244-80323046',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62eba0e1ecb705_85832197',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62eba0e1ecb705_85832197')) {function content_62eba0e1ecb705_85832197($_smarty_tpl) {?><?php if (!empty($_smarty_tpl->tpl_vars['features']->value)&&is_array($_smarty_tpl->tpl_vars['features']->value)){?>
    <div class="value s-product-feature-superposition" id="s-product-feature-superposition">
        <?php if ($_smarty_tpl->tpl_vars['product_has_incompatible_features_selectable']->value){?>
            ...
            <div><i class="icon16 exclamation-red"></i>Отключите некоторые артикулы в новом редакторе товаров, чтобы можно было редактировать их здесь</div>
        <?php }?>
