...
<?php /*%%SmartyHeaderCode:186716501762eba12d849647-50480084%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '186716501762eba12d849647-50480084',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62eba12d8bce15_48830046',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62eba12d8bce15_48830046')) {function content_62eba12d8bce15_48830046($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_wa_date')) include 'C:\\xampp\\htdocs\\wa\\wa-system/vendors/smarty-plugins\\modifier.wa_date.php';
...
"<?php if ($_smarty_tpl->tpl_vars['wa']->value->get($_smarty_tpl->tpl_vars['filter']->value['code'],'')===''){?> checked<?php }?> value=""> Неважно</label>
                    ...
                    <?php }elseif($_smarty_tpl->tpl_vars['filter']->value['type']=="range.date"){?>
                        <div class="s-filter-item s-range-date-item" id="js-filter-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>">
                            ...
                            <script>
                                ( function($) {
                                    var $filter = $("#js-filter-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['id'], ENT_QUOTES, 'UTF-8', true);?>
");
